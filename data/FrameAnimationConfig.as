package data
{
	...
	public class FrameAnimationConfig
	{
		...
		public function FrameAnimationConfig(data:Array)
		{
			...
			{
				frameQueue[arr[0]] = [arr[1],arr[2]];
			}
		}
		private static var _data:Array = [
			[100001,
				[
					[0,[0,1,2,3,4,5,6,7],"res\\character\\1"],
					[1,[8,9,10,11,12,13,14,15],"res\\character\\1"],
					[2,[0,1,2,3,4,5,6,7],"res\\character\\2"],
					[3,[8,9,10,11,12,13,14,15],"res\\character\\2"],
					[4,[16,17,18,19],"res\\character\\2"],
					[5,[16,17,18,19,20,21,22,23],"res\\character\\1"],],],
			[200001,
				[
					[0,[0,1,2,3,4,5,6,7],"res\\weapon\\1"],
					[1,[8,9,10,11,12,13,14,15],"res\\weapon\\1"],
					[2,[16,17,18,19,20,21,22,23],"res\\weapon\\1"],
					[3,[24,25,26,27,28,29,30,31],"res\\weapon\\1"],
					[4,[32,33,34,35],"res\\weapon\\1"],
					[5,[0,1,2,3,4,5,6,7],"res\\weapon\\2"],],],
